...
let starter = pokemon.filter(pokemon => pokemon.starter === true);

starter.forEach(pokemon => {
...
let pokeball = game.items.find(item => item.name === "pokeball");
 if(pokeball && pokeball.quantity > 0) {
  pokeball.quantity -= 1;
 } else {console.log("You can not complete this action!")}
};
game.catchPokemon = catchPokemon;
...
// see previous excersize

console.log(`${gymTally.completed}`)
console.log(`${gymTally.incomplete}`)
...
console.log(`You have ${partyCount} pokemon in your party!`)
